      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            if (user['idImage'] != null && user['idImage'].toString().isNotEmpty)
              Padding(
                padding: const EdgeInsets.only(right: 40.0, left: 8.0, top: 8.0),
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(
                          languageProvider.isEnglish ? 'ID Image' : 'صورة الهوية',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: Colors.grey[700],
                          ),
                        ...
                        if (isRejecting && !_rejectAll)
                          Checkbox(
                            value: _selectedFields.contains('idImage'),
                            onChanged: (val) {
                              setState(() {
                                if (val == true) {
                                  _selectedFields.add('idImage');
                                } else {
                                  _selectedFields.remove('idImage');
                                }
                              });
                            },
                          ),
