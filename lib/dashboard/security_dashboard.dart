...
class SecurityDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const RoleGuard(
      allowedRole: UserRole.security,
      child: _SecurityDashboardContent(),
    );
  }
}

class _SecurityDashboardContent extends StatefulWidget {
  const _SecurityDashboardContent();

  @override
  State<_SecurityDashboardContent> createState() => _SecurityDashboardState();
}

class _SecurityDashboardState extends State<_SecurityDashboardContent> {
